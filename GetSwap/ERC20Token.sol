...
contract GETERC20 is IERC20, Ownable {
    ...
    constructor(string memory Aname, string memory Asymbol, uint256 ASupply) public {
        _decimals = 18;
		_totalSupply = ASupply * 10 ** uint256(_decimals);
